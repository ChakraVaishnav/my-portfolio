...
const Experience = () => {
    return (
        <section id="experience" className="bg-near-black py-12 md:py-20 px-6">
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="border-l border-subtle-gray pl-8 md:pl-16 py-4 space-y-16">
                    <div className="relative">
                        <div className="absolute -left-[33px] md:-left-[65px] top-2 w-3 h-3 bg-pure-white ring-4 ring-near-black" />
                        ...
                        <div className="flex flex-col md:flex-row md:items-baseline gap-4 md:gap-8 mb-6">
                            ...
                            <span className="text-light-gray font-mono text-sm">Dec 2025 — Feb 2025</span>
                        </div>
