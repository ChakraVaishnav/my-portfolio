        ...
        >
            ...
            <div className="max-w-[1800px] w-full mx-auto grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="relative order-1 md:order-2 flex flex-col justify-center space-y-8 z-20 pt-2 md:pt-0 pl-8 md:pl-24 lg:pl-32">
                    ...
                    <button
                        onClick={toggleTheme}
                        className="absolute top-0 right-0 text-pure-white opacity-80 hover:opacity-100 transition-opacity p-2 hover:bg-pure-white/10"
                    ...
                    >
                        ...
                        <p>
                            Creator of <span className="text-pure-white font-medium">COREsume</span> (220+ users) and
